...
interface EmailVerificationRequiredProps {
  ...
  feature: 'booking' | 'blog';
}

export default function EmailVerificationRequired({ children, feature }: EmailVerificationRequiredProps) {
  ...
  if (!currentUser.emailVerified) {
    const featureText = feature === 'booking' ? 'book tours' : 'post blogs';
          ...
          <Card className="shadow-2xl border-0 bg-white/95 backdrop-blur-sm">
            <CardHeader className="text-center pb-4">
              ...
              <CardDescription className="text-gray-600">
                Please verify your email address to {featureText}
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <Alert>
                ...
                <AlertDescription>
                  You must verify your email address before you can {featureText}. Check your email for the verification link.
                </AlertDescription>
              </Alert>
