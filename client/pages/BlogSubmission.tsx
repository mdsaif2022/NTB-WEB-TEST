...
export default function BlogSubmission() {
  ...
  const handleVideoUpload = (url: string, publicId: string) => {
    if (formData.videos.length >= 2) {
      alert("You can upload maximum 2 videos per blog post.");
      return;
    }
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const newPost = addBlogPost({
        ...
        comments: 0,
        views: 0,
        images: formData.images.map(img => img.url), // Use Cloudinary URLs
        tags: formData.tags,
      });
  ...
  return (
    <EmailVerificationRequired feature="blog">
      <div className="min-h-screen bg-gray-50">
        <Navigation />
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <Card>
                ...
                <CardContent className="space-y-6">
                  ...
                  {/* Video Upload */}
                  <div>
                    <Label>Videos (Optional, max 2)</Label>
                    <CloudinaryUpload
                      onUpload={handleVideoUpload}
                      onRemove={handleVideoRemove}
                      accept="video"
                      folder="ntb-web/blog-videos"
                      maxSize={100}
                      multiple={true}
